...
| `http://localhost:8080/ui/corpus` | Curator board: PDF-native boundary review, Finalize → Review reps (+ suggest-only assist), Activate / revert ([ADR-0047](adr/0047-ingestion-versions.md)–[ADR-0049](adr/0049-pdf-native-semantic-boundaries.md), [ADR-0053](adr/0053-reps-review-assist.md)). Diagram: [architecture/08](architecture/08-semantic-curator-to-generate.md). Propose and assist need `SEMANTIC_OPENAI_API_KEY`; marker review and cutover do not. |
