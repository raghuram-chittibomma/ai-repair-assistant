...
| [05 — Ask vs diagnose](05-runtime-ask-diagnose.md) | Runtime | Ask one-shot path vs LangGraph diagnose nodes + session; PDF-primary semantic evidence |
...
| [08 — Semantic curator → generate](08-semantic-curator-to-generate.md) | End-to-end | Opt-in LLM page markers → human PDF board → activate → retrieve reps → stub+PDF generate |
