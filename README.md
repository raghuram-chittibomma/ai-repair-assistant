...
- **Grounded Q&A / diagnose** — citations, abstain, checklist path discipline, gated source-page overlay ([ADR-0012](docs/adr/0012-grounded-qa.md), [ADR-0013](docs/adr/0013-langgraph-diagnostic.md), [ADR-0036](docs/adr/0036-ui-source-page-images.md))
