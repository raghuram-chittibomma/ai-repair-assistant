...
from repair_assistant.qa.env import DEFAULT_JUDGE_LLM_MODEL, DEFAULT_LLM_MODEL
...
def test_default_llm_model_is_a_dated_snapshot() -> None:
    ...
    assert DEFAULT_JUDGE_LLM_MODEL != DEFAULT_LLM_MODEL
    assert DEFAULT_JUDGE_LLM_MODEL != "gpt-4o-mini"
